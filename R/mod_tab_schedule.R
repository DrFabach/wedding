  ...
  moduleServer( id, function(input, output, session){
    ...
    observeEvent(r_global$partie,ignoreInit = F,{
      ...
      output$programme <- renderUI({ 
        ...
        debut<-tagList(tags$p("Segen", style = "font-family: \'Bauer Bodoni Std 1\'; font-size: 30px; letter-spacing:5px; text-align: center"),
                       tags$p("11 Uhr", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                       tags$p("Paulus Kapelle", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                       tags$br(style = "line-height: 80px"),
                       
                       tags$p("Rathaus", style = "font-family: \'Bauer Bodoni Std 1\'; font-size: 30px; letter-spacing:5px; text-align: center"),
                       tags$p("12 Uhr", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                       tags$p("Meisenthal", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                       tags$br(style = "line-height: 80px"))
        milieu<-
          tagList(tags$p("Laizistische Zeremonie", style = "font-family: \'Bauer Bodoni Std 1\'; font-size: 30px; letter-spacing:5px; text-align: center"),
        ...
        fin <- tagList(tags$br(style = "line-height: 80px"),
                       ...
                       tags$p("19 Uhr 30", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                       tags$p("Gemeindesaal Lichtenberg", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                       tags$br(style = "line-height: 80px"),
                       tags$p("Brunch", style = "font-family: \'Bauer Bodoni Std 1\'; font-size: 30px; letter-spacing:5px; text-align: center"),
                       tags$p("10.30 Uhr am nächsten Tag", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"),
                       tags$p("Gemeindesaal Lichtenberg", style = "font-family: \'MrsEavesItalic\'; letter-spacing:3px; text-align: center"))
        if(partie =="tout"){
          return(tagList(
